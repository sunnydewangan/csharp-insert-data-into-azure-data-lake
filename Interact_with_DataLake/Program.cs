...
namespace AdlsSDKGettingStarted
{
    ...
    {
        private static string applicationId = "<app id>";     // Also called client id
        private static string clientSecret = "<Client Secret>";
        private static string tenantId = "<AD tenant ID>";
        private static string adlsAccountFQDN = "<Datalake URL>";   // full account FQDN, not just the account name like example.azure.datalakestore.net
        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
                string fileName = "/Test/testFilename2.txt";
